...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class NationalCostumeController(LogService logService, ILogger<NationalCostumeController> logger, AuthenUtils authenUtils, IWebHostEnvironment environment, NationalCostumeCategoryService nationalCostumeCategoryService, NationalCostumeService nationalCostumeService, PeopleService peopleService) : BaseController<NationalCostumeController>(logger, authenUtils,logService)
    {
