...
namespace WebApp.Common
{
    public class LandmarkExcel
    {
        ...
        public List<LandmarkModel> Datas { set; get; } = new List<LandmarkModel>();
        /// <summary>
        /// Instance of this
        /// </summary>
        ...
        public LandmarkExcel(ILogger logger,string path,int userId)
        {
            _logger = logger;
        ...
        public void Read()
        {
            try
            {
                ...
                {
                    var value = JsonConvert.DeserializeObject<LandmarkExcel>(System.IO.File.ReadAllText(filePath));
                    if (value != null)
                    {
