...
{
    [Area(nameof(Admin))]
    [Route(nameof(Admin) + "/file-system")]
    public class FileSystemController : Controller
    {
        IWebHostEnvironment _env;
        AuthenUtils _authenUtils;
        public FileSystemController(IWebHostEnvironment env, AuthenUtils authenUtils)
        {
            _env = env;
        ...
        private Connector GetConnector()
        {
            ...
            string urlthumb = $"{uri.Scheme}://{uri.Authority}/Admin/file-system/thumb/";
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "datas", // Beautiful name given to the root/home folder
