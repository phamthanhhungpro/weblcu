...
{
    /// <inheritdoc />
    public partial class AddFestival : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Festivals_Peoples_PeopleId",
                        column: x => x.PeopleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_FestivalId",
                table: "Attachments",
                column: "FestivalId");

            migrationBuilder.CreateIndex(
                name: "IX_Festivals_PeopleId",
                table: "Festivals",
                column: "PeopleId");

            migrationBuilder.AddForeignKey(
                name: "FK_Attachments_Festivals_FestivalId",
                table: "Attachments",
                column: "FestivalId",
