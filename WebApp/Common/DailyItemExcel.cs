...
namespace WebApp.Common
{
    public class DailyItemExcel
    {
        ...
        public List<DailyItemModel> Datas { set; get; } = new List<DailyItemModel>();
        /// <summary>
        /// Instance of this
        /// </summary>
        ...
        public DailyItemExcel(ILogger logger,string path,int userId)
        {
            _logger = logger;
        ...
        public void Read()
        {
            try
            {
                ...
                {
                    var value = JsonConvert.DeserializeObject<DailyItemExcel>(System.IO.File.ReadAllText(filePath));
                    if (value != null)
                    {
